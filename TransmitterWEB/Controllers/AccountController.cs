...
namespace TransmitterWEB.Controllers
{
    ...
    public class AccountController : _baseController
    {
        ...
        public AccountController(ICustomerService srvCustmer)
        {
            _customerSrv = srvCustmer;
        }
        ...
        {
            Customer cst = createBaseCustomer();

            RegisterViewModel model = new RegisterViewModel();
            model.Email = "admin@transmitter.com";
            model.Password = "1q2w3e";
            model.ConfirmPassword = "1q2w3e";
            model.CustomerId = cst.Id;
            if (ModelState.IsValid)
            {
        ...
        private Customer createBaseCustomer()
        {
            ...
            cst.Email = "admin@transmitter.com";
            cst.Name = "Transmitter";
            _customerSrv.Insert(cst);
            return cst;
        }
